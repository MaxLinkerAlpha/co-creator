 ...
 * 
 * 多国助教说明：
 * 本项目支持 6 个国家的 AI 助教，每个助教都有独特的个性和教学风格：
 * - Marcus (古罗马): 毒舌吐槽，教你拉丁语
 * - Max & Wolfgang (德国柏林): 口语 vs 中二演讲风格
 * - Hugo & Mateo (西班牙/墨西哥): 半岛音 vs 拉美腔
 * - 翔太 & 飒太 (日本): 极端口语 vs 严格敬语
 * - Leo 一家 (英美): 英美文化冲突
 * - Enzo (法国巴黎): 法式抱怨艺术
 * 
 * 所有助教均可配置吐槽频率（高频/正常/低频/慢写/手动）
 */
